<template>
  <div class="relative min-h-dvh text-white overflow-hidden">
...
const { active: loadingActive, showBrief } = useLoadingOverlay()
...
watch(
  ...
  () => {
    closeMobileMenu()
    // show a very quick overlay just to signal navigation
    if (process.client) showBrief(320)
  }
)
