<template>
  <div class="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
    ...
    <div
      ...
      style="background:
        radial-gradient(circle at 50% 45%, rgba(0,0,0,0.12), rgba(0,0,0,0.68) 62%, rgba(0,0,0,0.86)),
    ...
    <div
      ...
      style="background:
        ...
        repeating-linear-gradient(90deg, rgba(255,255,255,0.02) 0 1px, transparent 1px 260px);
        filter: blur(0.4px);
      "
    />
